          ...
          <>
            <li
              ...
              className={cn([
                ...
                'data-[variant=horizontal]:flex-col data-[variant=horizontal]:items-center',
              ])}
            ...
            >
              <Button
                ...
                className={cn(
                  ...
                  dataState === 'completed' && 'bg-blue-600 hover:bg-blue-700 text-white',
                  dataState === 'active' &&
                    'bg-blue-600 hover:bg-blue-700 text-white ring-2 ring-blue-200',
                  dataState === 'inactive' && 'bg-gray-200 hover:bg-gray-300 text-gray-400',
                )}
                size="icon"
              ...
              <div
                ...
                className={cn(
                  ...
                  variant === 'horizontal' && 'items-center mt-2 text-center',
                )}
              >
                {title}
                {description}
